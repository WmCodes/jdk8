...
public class FunctionTest2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(test.compute3(1,2,(integer, integer2) -> integer- integer2 ));

        System.out.println(test.compute4(2,3,(integer, integer2) -> integer+integer2,integer -> integer*integer));
    }
